""" This file trains the model, see the README for instructions on how to use."""
...
from data_utilities import TrainDatasetFromFolder, ValDatasetFromFolder, display_transform, ssim
...
if __name__ == "__main__":
    ...
    val_set = ValDatasetFromFolder('data/Validate_HR', upscale_factor=UPSCALE_FACTOR)
